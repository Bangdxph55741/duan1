    ...
    <section class="">
        ...
        <main>
            <div class="grid wide ">
                ...
                <section class="products row  justify-content grid wide">
            ...
            <div class="grid wide">
                ...
                <section class="products row  justify-content">
                    <article class="product product-5 m-4 c-12">
                        <div class="product-image">
                            <img
                                src="https://m.yodycdn.com/fit-in/filters:format(webp)/products/ao-giu-nhiet-nu-yody-ATN7007-DEN%20(13).jpg"
